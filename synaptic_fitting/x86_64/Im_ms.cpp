...
#define gIm _ml->template fpfield<6>(_iml)
#define gIm_columnindex 6
...
#define PKAci _ml->template fpfield<14>(_iml)
#define PKAci_columnindex 14
...
#define hill hill_Im_ms
 ...
 {"gbar_Im_ms", "S/cm2"},
 {"mod_pka_g_min_Im_ms", "1"},
 {"mod_pka_g_max_Im_ms", "1"},
 {"mod_pka_g_half_Im_ms", "mM"},
 {"mod_pka_g_hill_Im_ms", "1"},
 {"ik_Im_ms", "mA/cm2"},
 {"gIm_Im_ms", "S/cm2"},
 {"modulation_factor_Im_ms", "1"},
 {0, 0}
};
...
"Im_ms",
 ...
 "mod_pka_g_min_Im_ms",
 "mod_pka_g_max_Im_ms",
 "mod_pka_g_half_Im_ms",
 "mod_pka_g_hill_Im_ms",
 0,
 "ik_Im_ms",
 "gIm_Im_ms",
 "modulation_factor_Im_ms",
 0,
 "m_Im_ms",
 0,
 0};
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"gIm"} /* 6 */,
                                       ...
                                       _nrn_mechanism_field<double>{"PKAci"} /* 14 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Im_ms /cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/Im_ms.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/Im_ms.mod";
