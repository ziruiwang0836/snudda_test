...
#define mAlpha _ml->template fpfield<9>(_iml)
#define mAlpha_columnindex 9
#define mBeta _ml->template fpfield<10>(_iml)
#define mBeta_columnindex 10
#define hInf _ml->template fpfield<11>(_iml)
#define hInf_columnindex 11
#define hTau _ml->template fpfield<12>(_iml)
#define hTau_columnindex 12
#define hAlpha _ml->template fpfield<13>(_iml)
#define hAlpha_columnindex 13
#define hBeta _ml->template fpfield<14>(_iml)
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"mAlpha"} /* 9 */,
                                       _nrn_mechanism_field<double>{"mBeta"} /* 10 */,
                                       _nrn_mechanism_field<double>{"hInf"} /* 11 */,
                                       _nrn_mechanism_field<double>{"hTau"} /* 12 */,
                                       _nrn_mechanism_field<double>{"hAlpha"} /* 13 */,
                                       _nrn_mechanism_field<double>{"hBeta"} /* 14 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Nap_Et2 /cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/Nap_Et2.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/Nap_Et2.mod";
