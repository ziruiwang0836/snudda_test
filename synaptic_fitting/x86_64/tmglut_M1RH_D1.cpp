...
#define failRate _ml->template fpfield<14>(_iml)
#define failRate_columnindex 14
#define maxMod_AMPADA _ml->template fpfield<15>(_iml)
#define maxMod_AMPADA_columnindex 15
#define levelDA _ml->template fpfield<16>(_iml)
#define levelDA_columnindex 16
#define maxMod_AMPAACh _ml->template fpfield<17>(_iml)
#define maxMod_AMPAACh_columnindex 17
#define modDA _ml->template fpfield<18>(_iml)
#define modDA_columnindex 18
#define maxMod_NMDADA _ml->template fpfield<19>(_iml)
#define maxMod_NMDADA_columnindex 19
#define modACh _ml->template fpfield<20>(_iml)
#define modACh_columnindex 20
#define maxMod_NMDAACh _ml->template fpfield<21>(_iml)
#define maxMod_NMDAACh_columnindex 21
#define levelACh _ml->template fpfield<22>(_iml)
#define levelACh_columnindex 22
#define failRateDA _ml->template fpfield<23>(_iml)
#define failRateDA_columnindex 23
#define failRateACh _ml->template fpfield<24>(_iml)
#define failRateACh_columnindex 24
#define use_stp _ml->template fpfield<25>(_iml)
#define use_stp_columnindex 25
#define i _ml->template fpfield<26>(_iml)
#define i_columnindex 26
#define i_ampa _ml->template fpfield<27>(_iml)
#define i_ampa_columnindex 27
#define i_nmda _ml->template fpfield<28>(_iml)
#define i_nmda_columnindex 28
#define g _ml->template fpfield<29>(_iml)
#define g_columnindex 29
#define g_ampa _ml->template fpfield<30>(_iml)
#define g_ampa_columnindex 30
#define g_nmda _ml->template fpfield<31>(_iml)
#define g_nmda_columnindex 31
#define A_ampa _ml->template fpfield<32>(_iml)
#define A_ampa_columnindex 32
#define B_ampa _ml->template fpfield<33>(_iml)
#define B_ampa_columnindex 33
#define C_ampa _ml->template fpfield<34>(_iml)
...
#define C_nmda _ml->template fpfield<37>(_iml)
#define C_nmda_columnindex 37
#define ical _ml->template fpfield<38>(_iml)
#define ical_columnindex 38
#define ical_ampa _ml->template fpfield<39>(_iml)
#define ical_ampa_columnindex 39
#define ical_nmda _ml->template fpfield<40>(_iml)
#define ical_nmda_columnindex 40
#define factor_ampa _ml->template fpfield<41>(_iml)
#define factor_ampa_columnindex 41
#define factor_nmda _ml->template fpfield<42>(_iml)
#define factor_nmda_columnindex 42
#define x _ml->template fpfield<43>(_iml)
...
#define DC_ampa _ml->template fpfield<46>(_iml)
#define DC_ampa_columnindex 46
#define DA_nmda _ml->template fpfield<47>(_iml)
#define DA_nmda_columnindex 47
#define DB_nmda _ml->template fpfield<48>(_iml)
#define DB_nmda_columnindex 48
#define DC_nmda _ml->template fpfield<49>(_iml)
...
#define urand urand_tmGlut_M1RH_D1
 extern double modulationACh_AMPA( _internalthreadargsproto_ );
 extern double modulationDA_AMPA( _internalthreadargsproto_ );
 extern double modulationACh_NMDA( _internalthreadargsproto_ );
 extern double modulationDA_NMDA( _internalthreadargsproto_ );
  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 5, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 53);
 	...
 	tau1_ampa = _parm_default[0]; /* 0.819 */
 	tau2_ampa = _parm_default[1]; /* 4.626 */
 	tau1_nmda = _parm_default[2]; /* 1.729 */
 	tau2_nmda = _parm_default[3]; /* 34.413 */
 	...
 	failRate = _parm_default[14]; /* 0 */
 	maxMod_AMPADA = _parm_default[15]; /* 1 */
 	levelDA = _parm_default[16]; /* 0 */
 	maxMod_AMPAACh = _parm_default[17]; /* 1 */
 	modDA = _parm_default[18]; /* 0 */
 	maxMod_NMDADA = _parm_default[19]; /* 1 */
 	modACh = _parm_default[20]; /* 0 */
 	maxMod_NMDAACh = _parm_default[21]; /* 1 */
 	levelACh = _parm_default[22]; /* 0 */
 	failRateDA = _parm_default[23]; /* 0 */
 	failRateACh = _parm_default[24]; /* 0 */
 	use_stp = _parm_default[25]; /* 1 */
  }
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 53);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _tmglut_M1RH_D1_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("cal", 2.0);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"failRate"} /* 14 */,
                                       _nrn_mechanism_field<double>{"maxMod_AMPADA"} /* 15 */,
                                       _nrn_mechanism_field<double>{"levelDA"} /* 16 */,
                                       _nrn_mechanism_field<double>{"maxMod_AMPAACh"} /* 17 */,
                                       _nrn_mechanism_field<double>{"modDA"} /* 18 */,
                                       _nrn_mechanism_field<double>{"maxMod_NMDADA"} /* 19 */,
                                       _nrn_mechanism_field<double>{"modACh"} /* 20 */,
                                       _nrn_mechanism_field<double>{"maxMod_NMDAACh"} /* 21 */,
                                       _nrn_mechanism_field<double>{"levelACh"} /* 22 */,
                                       _nrn_mechanism_field<double>{"failRateDA"} /* 23 */,
                                       _nrn_mechanism_field<double>{"failRateACh"} /* 24 */,
                                       _nrn_mechanism_field<double>{"use_stp"} /* 25 */,
                                       _nrn_mechanism_field<double>{"i"} /* 26 */,
                                       _nrn_mechanism_field<double>{"i_ampa"} /* 27 */,
                                       _nrn_mechanism_field<double>{"i_nmda"} /* 28 */,
                                       _nrn_mechanism_field<double>{"g"} /* 29 */,
                                       _nrn_mechanism_field<double>{"g_ampa"} /* 30 */,
                                       _nrn_mechanism_field<double>{"g_nmda"} /* 31 */,
                                       _nrn_mechanism_field<double>{"A_ampa"} /* 32 */,
                                       _nrn_mechanism_field<double>{"B_ampa"} /* 33 */,
                                       _nrn_mechanism_field<double>{"C_ampa"} /* 34 */,
                                       _nrn_mechanism_field<double>{"A_nmda"} /* 35 */,
                                       _nrn_mechanism_field<double>{"B_nmda"} /* 36 */,
                                       _nrn_mechanism_field<double>{"C_nmda"} /* 37 */,
                                       _nrn_mechanism_field<double>{"ical"} /* 38 */,
                                       _nrn_mechanism_field<double>{"ical_ampa"} /* 39 */,
                                       _nrn_mechanism_field<double>{"ical_nmda"} /* 40 */,
                                       _nrn_mechanism_field<double>{"factor_ampa"} /* 41 */,
                                       _nrn_mechanism_field<double>{"factor_nmda"} /* 42 */,
                                       _nrn_mechanism_field<double>{"x"} /* 43 */,
                                       _nrn_mechanism_field<double>{"DA_ampa"} /* 44 */,
                                       _nrn_mechanism_field<double>{"DB_ampa"} /* 45 */,
                                       _nrn_mechanism_field<double>{"DC_ampa"} /* 46 */,
                                       _nrn_mechanism_field<double>{"DA_nmda"} /* 47 */,
                                       _nrn_mechanism_field<double>{"DB_nmda"} /* 48 */,
                                       _nrn_mechanism_field<double>{"DC_nmda"} /* 49 */,
 ...
 pnt_receive_size[_mechtype] = 5;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 tmGlut_M1RH_D1 /cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/tmglut_M1RH_D1.mod\n");
...
double modulationDA_NMDA ( _internalthreadargsproto_ ) {
...
static double _hoc_modulationDA_NMDA(void* _vptr) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if (gind != 0 && _thread != nullptr) { _globals = _thread[_gth].get<double*>(); }
  _nt = static_cast<NrnThread*>(_pnt->_vnt);
 _r =  modulationDA_NMDA ( _threadargs_ );
 return(_r);
}
 
double modulationACh_NMDA ( _internalthreadargsproto_ ) {
...
static double _hoc_modulationACh_NMDA(void* _vptr) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if (gind != 0 && _thread != nullptr) { _globals = _thread[_gth].get<double*>(); }
  _nt = static_cast<NrnThread*>(_pnt->_vnt);
 _r =  modulationACh_NMDA ( _threadargs_ );
 return(_r);
}
 
double modulationDA_AMPA ( _internalthreadargsproto_ ) {
...
static double _hoc_modulationDA_AMPA(void* _vptr) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if (gind != 0 && _thread != nullptr) { _globals = _thread[_gth].get<double*>(); }
  _nt = static_cast<NrnThread*>(_pnt->_vnt);
 _r =  modulationDA_AMPA ( _threadargs_ );
 return(_r);
}
 
double modulationACh_AMPA ( _internalthreadargsproto_ ) {
...
static double _hoc_modulationACh_AMPA(void* _vptr) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if (gind != 0 && _thread != nullptr) { _globals = _thread[_gth].get<double*>(); }
  _nt = static_cast<NrnThread*>(_pnt->_vnt);
 _r =  modulationACh_AMPA ( _threadargs_ );
 return(_r);
}
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/tmglut_M1RH_D1.mod";
