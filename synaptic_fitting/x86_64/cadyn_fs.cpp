...
#define drive_channel _ml->template fpfield<7>(_iml)
#define drive_channel_columnindex 7
#define drive_pump _ml->template fpfield<8>(_iml)
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"drive_channel"} /* 7 */,
                                       _nrn_mechanism_field<double>{"drive_pump"} /* 8 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 cadyn_fs /cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/cadyn_fs.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
 static double FARADAY = 0x1.78e555060882cp+16;
static int _reset;
static const char *modelname = "Calcium dynamics for N, P/Q, R calcium pool";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/cadyn_fs.mod";
