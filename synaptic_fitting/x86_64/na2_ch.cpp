...
#define c5 _ml->template fpfield<13>(_iml)
#define c5_columnindex 13
#define ct _ml->template fpfield<14>(_iml)
#define ct_columnindex 14
#define o _ml->template fpfield<15>(_iml)
#define o_columnindex 15
#define i1 _ml->template fpfield<16>(_iml)
#define i1_columnindex 16
#define i2 _ml->template fpfield<17>(_iml)
#define i2_columnindex 17
#define i3 _ml->template fpfield<18>(_iml)
#define i3_columnindex 18
#define i4 _ml->template fpfield<19>(_iml)
#define i4_columnindex 19
#define i5 _ml->template fpfield<20>(_iml)
#define i5_columnindex 20
#define i6 _ml->template fpfield<21>(_iml)
#define i6_columnindex 21
#define ift _ml->template fpfield<22>(_iml)
#define ift_columnindex 22
#define is1 _ml->template fpfield<23>(_iml)
#define is1_columnindex 23
#define is2 _ml->template fpfield<24>(_iml)
#define is2_columnindex 24
#define ist _ml->template fpfield<25>(_iml)
#define ist_columnindex 25
#define it _ml->template fpfield<26>(_iml)
#define it_columnindex 26
#define ena _ml->template fpfield<27>(_iml)
#define ena_columnindex 27
#define alpha _ml->template fpfield<28>(_iml)
#define alpha_columnindex 28
#define beta _ml->template fpfield<29>(_iml)
#define beta_columnindex 29
#define gamma _ml->template fpfield<30>(_iml)
#define gamma_columnindex 30
#define delta _ml->template fpfield<31>(_iml)
#define delta_columnindex 31
#define PKAci _ml->template fpfield<32>(_iml)
#define PKAci_columnindex 32
#define Dc1 _ml->template fpfield<33>(_iml)
#define Dc1_columnindex 33
#define Dc2 _ml->template fpfield<34>(_iml)
#define Dc2_columnindex 34
#define Dc3 _ml->template fpfield<35>(_iml)
#define Dc3_columnindex 35
#define Dc4 _ml->template fpfield<36>(_iml)
#define Dc4_columnindex 36
#define Dc5 _ml->template fpfield<37>(_iml)
#define Dc5_columnindex 37
#define Dct _ml->template fpfield<38>(_iml)
#define Dct_columnindex 38
#define Do _ml->template fpfield<39>(_iml)
#define Do_columnindex 39
#define Di1 _ml->template fpfield<40>(_iml)
#define Di1_columnindex 40
#define Di2 _ml->template fpfield<41>(_iml)
#define Di2_columnindex 41
#define Di3 _ml->template fpfield<42>(_iml)
#define Di3_columnindex 42
#define Di4 _ml->template fpfield<43>(_iml)
#define Di4_columnindex 43
#define Di5 _ml->template fpfield<44>(_iml)
#define Di5_columnindex 44
#define Di6 _ml->template fpfield<45>(_iml)
#define Di6_columnindex 45
#define Dift _ml->template fpfield<46>(_iml)
#define Dift_columnindex 46
#define Dis1 _ml->template fpfield<47>(_iml)
#define Dis1_columnindex 47
#define Dis2 _ml->template fpfield<48>(_iml)
#define Dis2_columnindex 48
#define Dist _ml->template fpfield<49>(_iml)
#define Dist_columnindex 49
#define Dit _ml->template fpfield<50>(_iml)
#define Dit_columnindex 50
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"modulation_na2_ch", _hoc_modulation},
...
#define modulation modulation_na2_ch
...
#define vha vha_na2_ch
 ...
 {"Ooff_na2_ch", "1/ms"},
 {"gbar_na2_ch", "S/cm2"},
 {"mod_pka_g_min_na2_ch", "1"},
 {"mod_pka_g_max_na2_ch", "1"},
 {"mod_pka_g_half_na2_ch", "mM"},
 {"mod_pka_g_slope_na2_ch", "mM"},
 {"g_na2_ch", "S/cm2"},
 {"ina_na2_ch", "mA/cm2"},
 {"modulation_factor_na2_ch", "1"},
 {0, 0}
};
 static double ct0 = 0;
 static double c50 = 0;
...
"na2_ch",
 "gbar_na2_ch",
 "mod_pka_g_min_na2_ch",
 "mod_pka_g_max_na2_ch",
 "mod_pka_g_half_na2_ch",
 "mod_pka_g_slope_na2_ch",
 0,
 "g_na2_ch",
 "ina_na2_ch",
 "a_na2_ch",
 "modulation_factor_na2_ch",
 0,
 "c1_na2_ch",
 "c2_na2_ch",
 "c3_na2_ch",
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"c5"} /* 13 */,
                                       _nrn_mechanism_field<double>{"ct"} /* 14 */,
                                       _nrn_mechanism_field<double>{"o"} /* 15 */,
                                       _nrn_mechanism_field<double>{"i1"} /* 16 */,
                                       _nrn_mechanism_field<double>{"i2"} /* 17 */,
                                       _nrn_mechanism_field<double>{"i3"} /* 18 */,
                                       _nrn_mechanism_field<double>{"i4"} /* 19 */,
                                       _nrn_mechanism_field<double>{"i5"} /* 20 */,
                                       _nrn_mechanism_field<double>{"i6"} /* 21 */,
                                       _nrn_mechanism_field<double>{"ift"} /* 22 */,
                                       _nrn_mechanism_field<double>{"is1"} /* 23 */,
                                       _nrn_mechanism_field<double>{"is2"} /* 24 */,
                                       _nrn_mechanism_field<double>{"ist"} /* 25 */,
                                       _nrn_mechanism_field<double>{"it"} /* 26 */,
                                       _nrn_mechanism_field<double>{"ena"} /* 27 */,
                                       _nrn_mechanism_field<double>{"alpha"} /* 28 */,
                                       _nrn_mechanism_field<double>{"beta"} /* 29 */,
                                       _nrn_mechanism_field<double>{"gamma"} /* 30 */,
                                       _nrn_mechanism_field<double>{"delta"} /* 31 */,
                                       _nrn_mechanism_field<double>{"PKAci"} /* 32 */,
                                       _nrn_mechanism_field<double>{"Dc1"} /* 33 */,
                                       _nrn_mechanism_field<double>{"Dc2"} /* 34 */,
                                       _nrn_mechanism_field<double>{"Dc3"} /* 35 */,
                                       _nrn_mechanism_field<double>{"Dc4"} /* 36 */,
                                       _nrn_mechanism_field<double>{"Dc5"} /* 37 */,
                                       _nrn_mechanism_field<double>{"Dct"} /* 38 */,
                                       _nrn_mechanism_field<double>{"Do"} /* 39 */,
                                       _nrn_mechanism_field<double>{"Di1"} /* 40 */,
                                       _nrn_mechanism_field<double>{"Di2"} /* 41 */,
                                       _nrn_mechanism_field<double>{"Di3"} /* 42 */,
                                       _nrn_mechanism_field<double>{"Di4"} /* 43 */,
                                       _nrn_mechanism_field<double>{"Di5"} /* 44 */,
                                       _nrn_mechanism_field<double>{"Di6"} /* 45 */,
                                       _nrn_mechanism_field<double>{"Dift"} /* 46 */,
                                       _nrn_mechanism_field<double>{"Dis1"} /* 47 */,
                                       _nrn_mechanism_field<double>{"Dis2"} /* 48 */,
                                       _nrn_mechanism_field<double>{"Dist"} /* 49 */,
                                       _nrn_mechanism_field<double>{"Dit"} /* 50 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 na2_ch /cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/na2_ch.mod\n");
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_na2_ch. Requires prior call to setdata_na2_ch and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/na2_ch.mod";
