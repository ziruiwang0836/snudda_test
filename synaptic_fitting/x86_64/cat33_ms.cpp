 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 cat33_ms /cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/cat33_ms.mod\n");
...
static int _reset;
static const char *modelname = "T-type calcium current (Cav3.3)";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/cat33_ms.mod";
