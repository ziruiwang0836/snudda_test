...
#define q q_kir_ms
 ...
 {"gbar_kir_ms", "S/cm2"},
 {"shift_kir_ms", "mV"},
 {"mod_pka_g_min_kir_ms", "1"},
 {"mod_pka_g_max_kir_ms", "1"},
 {"mod_pka_g_half_kir_ms", "mM"},
 {"mod_pka_g_hill_kir_ms", "1"},
 {"ik_kir_ms", "mA/cm2"},
 {"gk_kir_ms", "S/cm2"},
 {"modulation_factor_kir_ms", "1"},
 {0, 0}
};
...
"kir_ms",
 "gbar_kir_ms",
 "shift_kir_ms",
 "mod_pka_g_min_kir_ms",
 "mod_pka_g_max_kir_ms",
 "mod_pka_g_half_kir_ms",
 "mod_pka_g_hill_kir_ms",
 0,
 "ik_kir_ms",
 "gk_kir_ms",
 "modulation_factor_kir_ms",
 0,
 "m_kir_ms",
 0,
 0};
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 kir_ms /cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/kir_ms.mod\n");
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_kir_ms. Requires prior call to setdata_kir_ms and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/kir_ms.mod";
