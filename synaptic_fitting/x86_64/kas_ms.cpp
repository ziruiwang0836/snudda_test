...
#define htau _ml->template fpfield<14>(_iml)
...
#define q q_kas_ms
 ...
 {"gbar_kas_ms", "S/cm2"},
 {"mod_pka_g_min_kas_ms", "1"},
 {"mod_pka_g_max_kas_ms", "1"},
 {"mod_pka_g_half_kas_ms", "mM"},
 {"mod_pka_g_hill_kas_ms", "mM"},
 {"ik_kas_ms", "mA/cm2"},
 {"gk_kas_ms", "S/cm2"},
 {"modulation_factor_kas_ms", "1"},
 {0, 0}
};
...
"kas_ms",
 "gbar_kas_ms",
 "mod_pka_g_min_kas_ms",
 "mod_pka_g_max_kas_ms",
 "mod_pka_g_half_kas_ms",
 "mod_pka_g_hill_kas_ms",
 0,
 "ik_kas_ms",
 "gk_kas_ms",
 "modulation_factor_kas_ms",
 0,
 "m_kas_ms",
 "h_kas_ms",
 0,
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"htau"} /* 14 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 kas_ms /cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/kas_ms.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/kas_ms.mod";
