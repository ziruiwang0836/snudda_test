...
#define t _nt->_t
#define dt _nt->_dt
#define quanta _ml->template fpfield<0>(_iml)
#define quanta_columnindex 0
#define tau _ml->template fpfield<1>(_iml)
#define tau_columnindex 1
#define open _ml->template fpfield<2>(_iml)
#define open_columnindex 2
#define Dopen _ml->template fpfield<3>(_iml)
#define Dopen_columnindex 3
  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 3, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 7);
 	...
 	quanta = _parm_default[0]; /* 0.0001 */
 	tau = _parm_default[1]; /* 10 */
  }
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 7);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"quanta"} /* 0 */,
                                       _nrn_mechanism_field<double>{"tau"} /* 1 */,
                                       _nrn_mechanism_field<double>{"open"} /* 2 */,
                                       _nrn_mechanism_field<double>{"Dopen"} /* 3 */,
 ...
 pnt_receive_size[_mechtype] = 1;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 DASyn /cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/DASyn.mod\n");
...
/*CVODE*/
 ...
 static int _ode_matsol1 (_internalthreadargsproto_) {
 Dopen = Dopen  / (1. - dt*( ( - 1.0 ) / tau )) ;
  return 0;
}
 /*END CVODE*/
 static int state (_internalthreadargsproto_) { {
    open = open + (1. - exp(dt*(( - 1.0 ) / tau)))*(- ( 0.0 ) / ( ( - 1.0 ) / tau ) - open) ;
   }
  return 0;
}
...
{  Prop* _p; Datum* _ppvar; Datum* _thread; NrnThread* _nt;
 ...
 _tsav = t; {
    ...
    double __state = open;
    double __primary = (open + _args[0]) - __state;
...
static void _initlists(){
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = {open_columnindex, 0};  _dlist1[0] = {Dopen_columnindex, 0};
_first = 0;
}

#if NMODL_TEXT
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/DASyn.mod";
