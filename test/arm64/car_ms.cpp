...
#define modulation_factor2 _ml->template fpfield<11>(_iml)
#define modulation_factor2_columnindex 11
#define m _ml->template fpfield<12>(_iml)
#define m_columnindex 12
#define h _ml->template fpfield<13>(_iml)
#define h_columnindex 13
#define eca _ml->template fpfield<14>(_iml)
...
#define minf _ml->template fpfield<17>(_iml)
#define minf_columnindex 17
#define mtau _ml->template fpfield<18>(_iml)
#define mtau_columnindex 18
#define hinf _ml->template fpfield<19>(_iml)
#define hinf_columnindex 19
#define htau _ml->template fpfield<20>(_iml)
#define htau_columnindex 20
#define PKAci _ml->template fpfield<21>(_iml)
#define PKAci_columnindex 21
#define Dm _ml->template fpfield<22>(_iml)
#define Dm_columnindex 22
#define Dh _ml->template fpfield<23>(_iml)
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"modulation_factor2"} /* 11 */,
                                       _nrn_mechanism_field<double>{"m"} /* 12 */,
                                       _nrn_mechanism_field<double>{"h"} /* 13 */,
                                       _nrn_mechanism_field<double>{"eca"} /* 14 */,
                                       _nrn_mechanism_field<double>{"cai"} /* 15 */,
                                       _nrn_mechanism_field<double>{"cao"} /* 16 */,
                                       _nrn_mechanism_field<double>{"minf"} /* 17 */,
                                       _nrn_mechanism_field<double>{"mtau"} /* 18 */,
                                       _nrn_mechanism_field<double>{"hinf"} /* 19 */,
                                       _nrn_mechanism_field<double>{"htau"} /* 20 */,
                                       _nrn_mechanism_field<double>{"PKAci"} /* 21 */,
                                       _nrn_mechanism_field<double>{"Dm"} /* 22 */,
                                       _nrn_mechanism_field<double>{"Dh"} /* 23 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 car_ms /Users/peirui/BasalGangliaData/data/neurons/mechanisms/car_ms.mod\n");
...
{ {
   ...
   ica = pbar * m * m * m * h * ghk ( _threadargscomma_ v , cai , cao ) * modulation_factor * modulation_factor2 ;
   }
 _current += ica;
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/peirui/BasalGangliaData/data/neurons/mechanisms/car_ms.mod";
