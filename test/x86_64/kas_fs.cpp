...
#define minf _ml->template fpfield<13>(_iml)
...
#define htau _ml->template fpfield<16>(_iml)
...
#define a a_kas_fs
 ...
 {"gbar_kas_fs", "S/cm2"},
 {"mod_pka_g_min_kas_fs", "1"},
 {"mod_pka_g_max_kas_fs", "1"},
 {"mod_pka_g_half_kas_fs", "mM"},
 {"mod_pka_g_slope_kas_fs", "mM"},
 {"ik_kas_fs", "mA/cm2"},
 {"gk_kas_fs", "S/cm2"},
 {"modulation_factor_kas_fs", "1"},
 {0, 0}
};
...
"kas_fs",
 ...
 "q_kas_fs",
 "shift_kas_fs",
 "mod_pka_g_min_kas_fs",
 "mod_pka_g_max_kas_fs",
 "mod_pka_g_half_kas_fs",
 "mod_pka_g_slope_kas_fs",
 0,
 "ik_kas_fs",
 "gk_kas_fs",
 "modulation_factor_kas_fs",
 0,
 "m_kas_fs",
 "h_kas_fs",
 0,
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"minf"} /* 13 */,
                                       _nrn_mechanism_field<double>{"mtau"} /* 14 */,
                                       _nrn_mechanism_field<double>{"hinf"} /* 15 */,
                                       _nrn_mechanism_field<double>{"htau"} /* 16 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 kas_fs /cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/kas_fs.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "Slowly inactivating A-type potassium current (Kv1.2)";
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_kas_fs. Requires prior call to setdata_kas_fs and that the specified mechanism instance still be in existence.", NULL);
  }
...
{ {
   ...
   gk = gbar * m * m * ( h * a + 1.0 - a ) * modulation_factor ;
   ik = gk * ( v - ek ) ;
   }
 _current += ik;
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/kas_fs.mod";
