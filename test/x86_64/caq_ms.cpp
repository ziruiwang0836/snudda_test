...
#define eca _ml->template fpfield<13>(_iml)
#define eca_columnindex 13
#define cai _ml->template fpfield<14>(_iml)
#define cai_columnindex 14
#define cao _ml->template fpfield<15>(_iml)
#define cao_columnindex 15
#define minf _ml->template fpfield<16>(_iml)
#define minf_columnindex 16
#define mtau _ml->template fpfield<17>(_iml)
#define mtau_columnindex 17
#define PKAci _ml->template fpfield<18>(_iml)
#define PKAci_columnindex 18
...
#define q q_caq_ms
 ...
 {"pbar_caq_ms", "cm/s"},
 {"mod_pka_p_min_caq_ms", "1"},
 {"mod_pka_p_max_caq_ms", "1"},
 {"mod_pka_p_half_caq_ms", "mM"},
 {"mod_pka_p_hill_caq_ms", "1"},
 {"mod_pka_p2_min_caq_ms", "1"},
 {"mod_pka_p2_max_caq_ms", "1"},
 {"mod_pka_p2_half_caq_ms", "mM"},
 {"mod_pka_p2_hill_caq_ms", "1"},
 {"ica_caq_ms", "mA/cm2"},
 {"modulation_factor_caq_ms", "1"},
 {"modulation_factor2_caq_ms", "1"},
 {0, 0}
};
...
"caq_ms",
 "pbar_caq_ms",
 "mod_pka_p_min_caq_ms",
 "mod_pka_p_max_caq_ms",
 "mod_pka_p_half_caq_ms",
 "mod_pka_p_hill_caq_ms",
 "mod_pka_p2_min_caq_ms",
 "mod_pka_p2_max_caq_ms",
 "mod_pka_p2_half_caq_ms",
 "mod_pka_p2_hill_caq_ms",
 0,
 "ica_caq_ms",
 "modulation_factor_caq_ms",
 "modulation_factor2_caq_ms",
 0,
 "m_caq_ms",
 0,
 0};
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"eca"} /* 13 */,
                                       _nrn_mechanism_field<double>{"cai"} /* 14 */,
                                       _nrn_mechanism_field<double>{"cao"} /* 15 */,
                                       _nrn_mechanism_field<double>{"minf"} /* 16 */,
                                       _nrn_mechanism_field<double>{"mtau"} /* 17 */,
                                       _nrn_mechanism_field<double>{"PKAci"} /* 18 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 caq_ms /cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/caq_ms.mod\n");
...
{ {
   ...
   ica = pbar * m * m * ghk ( _threadargscomma_ v , cai , cao ) * modulation_factor * modulation_factor2 ;
   }
 _current += ica;
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/caq_ms.mod";
