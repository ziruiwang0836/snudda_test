...
#define q q_can_ms
 ...
 {"pbar_can_ms", "cm/s"},
 {"mod_pka_g_min_can_ms", "1"},
 {"mod_pka_g_max_can_ms", "1"},
 {"mod_pka_g_half_can_ms", "mM"},
 {"mod_pka_g_hill_can_ms", "1"},
 {"ica_can_ms", "mA/cm2"},
 {"modulation_factor_can_ms", "1"},
 {0, 0}
};
...
"can_ms",
 "pbar_can_ms",
 "mod_pka_g_min_can_ms",
 "mod_pka_g_max_can_ms",
 "mod_pka_g_half_can_ms",
 "mod_pka_g_hill_can_ms",
 0,
 "ica_can_ms",
 "modulation_factor_can_ms",
 0,
 "m_can_ms",
 "h_can_ms",
 0,
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 can_ms /cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/can_ms.mod\n");
...
static int _reset;
static const char *modelname = "N-type calcium current (Cav2.2)";
...
{ {
   ...
   ica = pbar * m * m * ( h * a + 1.0 - a ) * ghk ( _threadargscomma_ v , cai , cao ) * modulation_factor ;
   }
 _current += ica;
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/can_ms.mod";
