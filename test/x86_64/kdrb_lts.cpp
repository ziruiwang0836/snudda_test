...
#define gkdr _ml->template fpfield<2>(_iml)
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"gkdr"} /* 2 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 kdrb_lts /cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/kdrb_lts.mod\n");
...
static void _hoc_alpn(void) {
  ...
  if(!_prop_id) {
    hoc_execerror("No data for alpn_kdrb_lts. Requires prior call to setdata_kdrb_lts and that the specified mechanism instance still be in existence.", NULL);
  } else {
...
static void _hoc_betn(void) {
  ...
  if(!_prop_id) {
    hoc_execerror("No data for betn_kdrb_lts. Requires prior call to setdata_kdrb_lts and that the specified mechanism instance still be in existence.", NULL);
  } else {
    _setdata(_extcall_prop);
  }
   _r =  betn (  *getarg(1) );
...
static void _hoc_rates(void) {
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_kdrb_lts. Requires prior call to setdata_kdrb_lts and that the specified mechanism instance still be in existence.", NULL);
  } else {
    _setdata(_extcall_prop);
  }
   _r = 1.;
 ...
 v=_v;
{
 ...
 { error =  states();
 if(error){
  std_cerr_stream << "at line 45 in file kdrb_lts.mod:\nBREAKPOINT {\n";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/kdrb_lts.mod";
