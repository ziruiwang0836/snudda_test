...
#define o _ml->template fpfield<2>(_iml)
...
#define oinf _ml->template fpfield<5>(_iml)
#define oinf_columnindex 5
#define otau _ml->template fpfield<6>(_iml)
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"o"} /* 2 */,
                                       _nrn_mechanism_field<double>{"cai"} /* 3 */,
                                       _nrn_mechanism_field<double>{"ek"} /* 4 */,
                                       _nrn_mechanism_field<double>{"oinf"} /* 5 */,
                                       _nrn_mechanism_field<double>{"otau"} /* 6 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 bk_ms /cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/bk_ms.mod\n");
...
static int _reset;
static const char *modelname = "BK-type calcium activated K channel (KCa1.1)";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/bk_ms.mod";
