...
#define o _ml->template fpfield<4>(_iml)
#define o_columnindex 4
#define ek _ml->template fpfield<5>(_iml)
#define ek_columnindex 5
#define alpha _ml->template fpfield<6>(_iml)
#define alpha_columnindex 6
#define beta _ml->template fpfield<7>(_iml)
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"o"} /* 4 */,
                                       _nrn_mechanism_field<double>{"ek"} /* 5 */,
                                       _nrn_mechanism_field<double>{"alpha"} /* 6 */,
                                       _nrn_mechanism_field<double>{"beta"} /* 7 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 kcnq_ch /cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/kcnq_ch.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "KCNQ/M current from striatal medium spiny neurons, used for ch. interneuron.";
...
#define _linmat1  1
 static int _spth1 = 0;
 static neuron::container::field_index _slist1[2], _dlist1[2]; static double *_temp1;
...
/*CVODE ode begin*/
 static int _ode_spec1(_internalthreadargsproto_) {
  ...
  {
 double b_flux, f_flux, _term; int _i;
 {int _i; for(_i=0;_i<2;_i++) _ml->data(_iml, _dlist1[_i]) = 0.0;}
 rates ( _threadargscomma_ v ) ;
 /* ~ c <-> o ( alpha , beta )*/
 f_flux =  alpha * c ;
 b_flux =  beta * o ;
...
static void _ode_matsol_instance1(_internalthreadargsproto_) {
 _cvode_sparse_thread(&(_thread[_cvspth1].literal_value<void*>()), 2, _dlist1, neuron::scopmath::row_view{_ml, _iml}, _ode_matsol1, _threadargs_);
 }
...
static void initmodel(_internalthreadargsproto_) {
  ...
  o = o0;
 {
    _ss_sparse_thread(&(_thread[_spth1].literal_value<void*>()), 2, _slist1, _dlist1, neuron::scopmath::row_view{_ml, _iml}, &t, dt, kin, _linmat1, _threadargs_);
     if (secondorder) {
    int _i;
    for (_i = 0; _i < 2; ++_i) {
...
{
  ek = _ion_ek;
 {  sparse_thread(&(_thread[_spth1].literal_value<void*>()), 2, _slist1, _dlist1, neuron::scopmath::row_view{_ml, _iml}, &t, dt, kin, _linmat1, _threadargs_);
     if (secondorder) {
    int _i;
    for (_i = 0; _i < 2; ++_i) {
      _ml->data(_iml, _slist1[_i]) += dt*_ml->data(_iml, _dlist1[_i]);
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/kcnq_ch.mod";
