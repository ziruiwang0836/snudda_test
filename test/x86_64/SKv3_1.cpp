 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 SKv3_1 /cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/SKv3_1.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/SKv3_1.mod";
  ...
  "\n"
  "COMMENT\n"
  "nej tack. paverkar framst isi, liten effekt p\n"
  "\n"
  " max spik och min ahp\n"
  "\n"
  "ENDCOMMENT\n"
  "\n"
  "NEURON	{\n"
