...
#define mod_pka_p2_min _ml->template fpfield<5>(_iml)
#define mod_pka_p2_min_columnindex 5
#define mod_pka_p2_max _ml->template fpfield<6>(_iml)
#define mod_pka_p2_max_columnindex 6
#define mod_pka_p2_half _ml->template fpfield<7>(_iml)
#define mod_pka_p2_half_columnindex 7
#define mod_pka_p2_hill _ml->template fpfield<8>(_iml)
#define mod_pka_p2_hill_columnindex 8
#define ica _ml->template fpfield<9>(_iml)
#define ica_columnindex 9
#define modulation_factor _ml->template fpfield<10>(_iml)
#define modulation_factor_columnindex 10
#define modulation_factor1 _ml->template fpfield<11>(_iml)
#define modulation_factor1_columnindex 11
#define modulation_factor2 _ml->template fpfield<12>(_iml)
#define modulation_factor2_columnindex 12
#define m _ml->template fpfield<13>(_iml)
#define m_columnindex 13
#define h _ml->template fpfield<14>(_iml)
#define h_columnindex 14
#define eca _ml->template fpfield<15>(_iml)
#define eca_columnindex 15
#define cai _ml->template fpfield<16>(_iml)
#define cai_columnindex 16
#define cao _ml->template fpfield<17>(_iml)
...
#define q q_car_ms
 ...
 {"pbar_car_ms", "cm/s"},
 {"mod_pka_p_min_car_ms", "1"},
 {"mod_pka_p_max_car_ms", "1"},
 {"mod_pka_p_half_car_ms", "mM"},
 {"mod_pka_p_hill_car_ms", "1"},
 {"mod_pka_p2_min_car_ms", "1"},
 {"mod_pka_p2_max_car_ms", "1"},
 {"mod_pka_p2_half_car_ms", "mM"},
 {"mod_pka_p2_hill_car_ms", "1"},
 {"ica_car_ms", "mA/cm2"},
 {"modulation_factor_car_ms", "1"},
 {"modulation_factor1_car_ms", "1"},
 {"modulation_factor2_car_ms", "1"},
 {0, 0}
};
...
"car_ms",
 "pbar_car_ms",
 "mod_pka_p_min_car_ms",
 "mod_pka_p_max_car_ms",
 "mod_pka_p_half_car_ms",
 "mod_pka_p_hill_car_ms",
 "mod_pka_p2_min_car_ms",
 "mod_pka_p2_max_car_ms",
 "mod_pka_p2_half_car_ms",
 "mod_pka_p2_hill_car_ms",
 0,
 "ica_car_ms",
 "modulation_factor_car_ms",
 "modulation_factor1_car_ms",
 "modulation_factor2_car_ms",
 0,
 "m_car_ms",
 "h_car_ms",
 0,
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 7, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 27);
 	...
 	mod_pka_p2_min = _parm_default[5]; /* 1 */
 	mod_pka_p2_max = _parm_default[6]; /* 1 */
 	mod_pka_p2_half = _parm_default[7]; /* 0.0001 */
 	mod_pka_p2_hill = _parm_default[8]; /* 4 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 27);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"mod_pka_p2_min"} /* 5 */,
                                       _nrn_mechanism_field<double>{"mod_pka_p2_max"} /* 6 */,
                                       _nrn_mechanism_field<double>{"mod_pka_p2_half"} /* 7 */,
                                       _nrn_mechanism_field<double>{"mod_pka_p2_hill"} /* 8 */,
                                       _nrn_mechanism_field<double>{"ica"} /* 9 */,
                                       _nrn_mechanism_field<double>{"modulation_factor"} /* 10 */,
                                       _nrn_mechanism_field<double>{"modulation_factor1"} /* 11 */,
                                       _nrn_mechanism_field<double>{"modulation_factor2"} /* 12 */,
                                       _nrn_mechanism_field<double>{"m"} /* 13 */,
                                       _nrn_mechanism_field<double>{"h"} /* 14 */,
                                       _nrn_mechanism_field<double>{"eca"} /* 15 */,
                                       _nrn_mechanism_field<double>{"cai"} /* 16 */,
                                       _nrn_mechanism_field<double>{"cao"} /* 17 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 car_ms /cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/car_ms.mod\n");
...
static int _reset;
static const char *modelname = "R-type calcium current (Cav2.3)";
...
{ {
   modulation_factor1 = hill ( _threadargscomma_ PKAci , mod_pka_p_min , mod_pka_p_max , mod_pka_p_half , mod_pka_p_hill ) ;
   modulation_factor2 = hill ( _threadargscomma_ PKAci , mod_pka_p2_min , mod_pka_p2_max , mod_pka_p2_half , mod_pka_p2_hill ) ;
   modulation_factor = modulation_factor1 * modulation_factor2 ;
   ica = pbar * m * m * m * h * ghk ( _threadargscomma_ v , cai , cao ) * modulation_factor ;
   }
 _current += ica;
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/car_ms.mod";
