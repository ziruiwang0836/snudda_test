...
static constexpr auto number_of_floating_point_variables = 63;
namespace {
template <typename T>
...
#define tauF _ml->template fpfield<3>(_iml)
#define tauF_columnindex 3
#define U _ml->template fpfield<4>(_iml)
#define U_columnindex 4
#define u0 _ml->template fpfield<5>(_iml)
#define u0_columnindex 5
#define ca_ratio_ampa _ml->template fpfield<6>(_iml)
#define ca_ratio_ampa_columnindex 6
#define ca_ratio_nmda _ml->template fpfield<7>(_iml)
#define ca_ratio_nmda_columnindex 7
#define mg _ml->template fpfield<8>(_iml)
#define mg_columnindex 8
#define mod_pka_g_ampa_min _ml->template fpfield<9>(_iml)
#define mod_pka_g_ampa_min_columnindex 9
#define mod_pka_g_ampa_max _ml->template fpfield<10>(_iml)
#define mod_pka_g_ampa_max_columnindex 10
#define mod_pka_g_ampa_half _ml->template fpfield<11>(_iml)
#define mod_pka_g_ampa_half_columnindex 11
#define mod_pka_g_ampa_slope _ml->template fpfield<12>(_iml)
#define mod_pka_g_ampa_slope_columnindex 12
#define mod_pka_g_nmda_min _ml->template fpfield<13>(_iml)
#define mod_pka_g_nmda_min_columnindex 13
#define mod_pka_g_nmda_max _ml->template fpfield<14>(_iml)
#define mod_pka_g_nmda_max_columnindex 14
#define mod_pka_g_nmda_half _ml->template fpfield<15>(_iml)
#define mod_pka_g_nmda_half_columnindex 15
#define mod_pka_g_nmda_slope _ml->template fpfield<16>(_iml)
#define mod_pka_g_nmda_slope_columnindex 16
#define failRate _ml->template fpfield<17>(_iml)
#define failRate_columnindex 17
#define use_stp _ml->template fpfield<18>(_iml)
#define use_stp_columnindex 18
#define tau1_ampa _ml->template fpfield<19>(_iml)
#define tau1_ampa_columnindex 19
#define tau2_ampa _ml->template fpfield<20>(_iml)
#define tau2_ampa_columnindex 20
#define tau3_ampa _ml->template fpfield<21>(_iml)
#define tau3_ampa_columnindex 21
#define I2_ampa _ml->template fpfield<22>(_iml)
#define I2_ampa_columnindex 22
#define I3_ampa _ml->template fpfield<23>(_iml)
#define I3_ampa_columnindex 23
#define tpeak_ampa _ml->template fpfield<24>(_iml)
#define tpeak_ampa_columnindex 24
#define factor_ampa _ml->template fpfield<25>(_iml)
#define factor_ampa_columnindex 25
#define tau1_nmda _ml->template fpfield<26>(_iml)
#define tau1_nmda_columnindex 26
#define tau2_nmda _ml->template fpfield<27>(_iml)
#define tau2_nmda_columnindex 27
#define tau3_nmda _ml->template fpfield<28>(_iml)
#define tau3_nmda_columnindex 28
#define I2_nmda _ml->template fpfield<29>(_iml)
#define I2_nmda_columnindex 29
#define I3_nmda _ml->template fpfield<30>(_iml)
#define I3_nmda_columnindex 30
#define tpeak_nmda _ml->template fpfield<31>(_iml)
#define tpeak_nmda_columnindex 31
#define factor_nmda _ml->template fpfield<32>(_iml)
#define factor_nmda_columnindex 32
#define nmda_ratio _ml->template fpfield<33>(_iml)
#define nmda_ratio_columnindex 33
#define i _ml->template fpfield<34>(_iml)
#define i_columnindex 34
#define i_ampa _ml->template fpfield<35>(_iml)
#define i_ampa_columnindex 35
#define i_nmda _ml->template fpfield<36>(_iml)
#define i_nmda_columnindex 36
#define g _ml->template fpfield<37>(_iml)
#define g_columnindex 37
#define g_ampa _ml->template fpfield<38>(_iml)
#define g_ampa_columnindex 38
#define g_nmda _ml->template fpfield<39>(_iml)
#define g_nmda_columnindex 39
#define modulation_factor_ampa _ml->template fpfield<40>(_iml)
#define modulation_factor_ampa_columnindex 40
#define modulation_factor_nmda _ml->template fpfield<41>(_iml)
#define modulation_factor_nmda_columnindex 41
#define modulation_factor_fail _ml->template fpfield<42>(_iml)
#define modulation_factor_fail_columnindex 42
#define A_ampa _ml->template fpfield<43>(_iml)
#define A_ampa_columnindex 43
#define B_ampa _ml->template fpfield<44>(_iml)
#define B_ampa_columnindex 44
#define C_ampa _ml->template fpfield<45>(_iml)
#define C_ampa_columnindex 45
#define A_nmda _ml->template fpfield<46>(_iml)
#define A_nmda_columnindex 46
#define B_nmda _ml->template fpfield<47>(_iml)
#define B_nmda_columnindex 47
#define C_nmda _ml->template fpfield<48>(_iml)
#define C_nmda_columnindex 48
#define ical _ml->template fpfield<49>(_iml)
#define ical_columnindex 49
#define ical_ampa _ml->template fpfield<50>(_iml)
#define ical_ampa_columnindex 50
#define ical_nmda _ml->template fpfield<51>(_iml)
#define ical_nmda_columnindex 51
#define x _ml->template fpfield<52>(_iml)
#define x_columnindex 52
#define PKAci _ml->template fpfield<53>(_iml)
#define PKAci_columnindex 53
#define DA_ampa _ml->template fpfield<54>(_iml)
#define DA_ampa_columnindex 54
#define DB_ampa _ml->template fpfield<55>(_iml)
#define DB_ampa_columnindex 55
#define DC_ampa _ml->template fpfield<56>(_iml)
#define DC_ampa_columnindex 56
#define DA_nmda _ml->template fpfield<57>(_iml)
#define DA_nmda_columnindex 57
#define DB_nmda _ml->template fpfield<58>(_iml)
#define DB_nmda_columnindex 58
#define DC_nmda _ml->template fpfield<59>(_iml)
#define DC_nmda_columnindex 59
#define v _ml->template fpfield<60>(_iml)
#define v_columnindex 60
#define _g _ml->template fpfield<61>(_iml)
#define _g_columnindex 61
#define _tsav _ml->template fpfield<62>(_iml)
#define _tsav_columnindex 62
...
#define modulation modulation_tmGlut_double
#define urand urand_tmGlut_double
 ...
 #define gind 0
 #define _gth 0
#define failRateScaling failRateScaling_tmGlut_double
 double failRateScaling = 0;
#define mod_pka_fail_slope mod_pka_fail_slope_tmGlut_double
 double mod_pka_fail_slope = 0.01;
#define mod_pka_fail_half mod_pka_fail_half_tmGlut_double
 double mod_pka_fail_half = 0.0001;
#define mod_pka_fail_max mod_pka_fail_max_tmGlut_double
 double mod_pka_fail_max = 0;
#define mod_pka_fail_min mod_pka_fail_min_tmGlut_double
 ...
 {"mod_pka_fail_min_tmGlut_double", "1"},
 {"mod_pka_fail_max_tmGlut_double", "1"},
 {"mod_pka_fail_half_tmGlut_double", "mM"},
 {"mod_pka_fail_slope_tmGlut_double", "mM"},
 {"e", "mV"},
 {"tau", "ms"},
 {"tauR", "ms"},
 {"tauF", "ms"},
 ...
 {"mod_pka_fail_min_tmGlut_double", &mod_pka_fail_min_tmGlut_double},
 {"mod_pka_fail_max_tmGlut_double", &mod_pka_fail_max_tmGlut_double},
 {"mod_pka_fail_half_tmGlut_double", &mod_pka_fail_half_tmGlut_double},
 {"mod_pka_fail_slope_tmGlut_double", &mod_pka_fail_slope_tmGlut_double},
 {"failRateScaling_tmGlut_double", &failRateScaling_tmGlut_double},
 {0, 0}
};
...
static void nrn_alloc(Prop* _prop) {
  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 8, _prop);
    ...
    size_t const _iml{};
    assert(_nrn_mechanism_get_num_vars(_prop) == 63);
 	/*initialize range parameters*/
 	e = _parm_default[0]; /* 0 */
 	tau = _parm_default[1]; /* 3 */
 	tauR = _parm_default[2]; /* 100 */
 	tauF = _parm_default[3]; /* 100 */
 	U = _parm_default[4]; /* 0.3 */
 	u0 = _parm_default[5]; /* 0.1 */
 	ca_ratio_ampa = _parm_default[6]; /* 0.005 */
 	ca_ratio_nmda = _parm_default[7]; /* 0.1 */
 	mg = _parm_default[8]; /* 1 */
 	mod_pka_g_ampa_min = _parm_default[9]; /* 1 */
 	mod_pka_g_ampa_max = _parm_default[10]; /* 1 */
 	mod_pka_g_ampa_half = _parm_default[11]; /* 0.0001 */
 	mod_pka_g_ampa_slope = _parm_default[12]; /* 0.01 */
 	mod_pka_g_nmda_min = _parm_default[13]; /* 1 */
 	mod_pka_g_nmda_max = _parm_default[14]; /* 1 */
 	mod_pka_g_nmda_half = _parm_default[15]; /* 0.0001 */
 	mod_pka_g_nmda_slope = _parm_default[16]; /* 0.01 */
 	failRate = _parm_default[17]; /* 0 */
 	use_stp = _parm_default[18]; /* 1 */
 	tau1_ampa = _parm_default[19]; /* 0 */
 	tau2_ampa = _parm_default[20]; /* 0 */
 	tau3_ampa = _parm_default[21]; /* 0 */
 	I2_ampa = _parm_default[22]; /* 0 */
 	I3_ampa = _parm_default[23]; /* 0 */
 	tpeak_ampa = _parm_default[24]; /* 0 */
 	factor_ampa = _parm_default[25]; /* 0 */
 	tau1_nmda = _parm_default[26]; /* 0 */
 	tau2_nmda = _parm_default[27]; /* 0 */
 	tau3_nmda = _parm_default[28]; /* 0 */
 	I2_nmda = _parm_default[29]; /* 0 */
 	I3_nmda = _parm_default[30]; /* 0 */
 	tpeak_nmda = _parm_default[31]; /* 0 */
 	factor_nmda = _parm_default[32]; /* 0 */
 	nmda_ratio = _parm_default[33]; /* 0 */
  }
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 63);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _tmglut_double_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("PKAc", 0.0);
 	ion_reg("cal", 2.0);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"tauF"} /* 3 */,
                                       _nrn_mechanism_field<double>{"U"} /* 4 */,
                                       _nrn_mechanism_field<double>{"u0"} /* 5 */,
                                       _nrn_mechanism_field<double>{"ca_ratio_ampa"} /* 6 */,
                                       _nrn_mechanism_field<double>{"ca_ratio_nmda"} /* 7 */,
                                       _nrn_mechanism_field<double>{"mg"} /* 8 */,
                                       _nrn_mechanism_field<double>{"mod_pka_g_ampa_min"} /* 9 */,
                                       _nrn_mechanism_field<double>{"mod_pka_g_ampa_max"} /* 10 */,
                                       _nrn_mechanism_field<double>{"mod_pka_g_ampa_half"} /* 11 */,
                                       _nrn_mechanism_field<double>{"mod_pka_g_ampa_slope"} /* 12 */,
                                       _nrn_mechanism_field<double>{"mod_pka_g_nmda_min"} /* 13 */,
                                       _nrn_mechanism_field<double>{"mod_pka_g_nmda_max"} /* 14 */,
                                       _nrn_mechanism_field<double>{"mod_pka_g_nmda_half"} /* 15 */,
                                       _nrn_mechanism_field<double>{"mod_pka_g_nmda_slope"} /* 16 */,
                                       _nrn_mechanism_field<double>{"failRate"} /* 17 */,
                                       _nrn_mechanism_field<double>{"use_stp"} /* 18 */,
                                       _nrn_mechanism_field<double>{"tau1_ampa"} /* 19 */,
                                       _nrn_mechanism_field<double>{"tau2_ampa"} /* 20 */,
                                       _nrn_mechanism_field<double>{"tau3_ampa"} /* 21 */,
                                       _nrn_mechanism_field<double>{"I2_ampa"} /* 22 */,
                                       _nrn_mechanism_field<double>{"I3_ampa"} /* 23 */,
                                       _nrn_mechanism_field<double>{"tpeak_ampa"} /* 24 */,
                                       _nrn_mechanism_field<double>{"factor_ampa"} /* 25 */,
                                       _nrn_mechanism_field<double>{"tau1_nmda"} /* 26 */,
                                       _nrn_mechanism_field<double>{"tau2_nmda"} /* 27 */,
                                       _nrn_mechanism_field<double>{"tau3_nmda"} /* 28 */,
                                       _nrn_mechanism_field<double>{"I2_nmda"} /* 29 */,
                                       _nrn_mechanism_field<double>{"I3_nmda"} /* 30 */,
                                       _nrn_mechanism_field<double>{"tpeak_nmda"} /* 31 */,
                                       _nrn_mechanism_field<double>{"factor_nmda"} /* 32 */,
                                       _nrn_mechanism_field<double>{"nmda_ratio"} /* 33 */,
                                       _nrn_mechanism_field<double>{"i"} /* 34 */,
                                       _nrn_mechanism_field<double>{"i_ampa"} /* 35 */,
                                       _nrn_mechanism_field<double>{"i_nmda"} /* 36 */,
                                       _nrn_mechanism_field<double>{"g"} /* 37 */,
                                       _nrn_mechanism_field<double>{"g_ampa"} /* 38 */,
                                       _nrn_mechanism_field<double>{"g_nmda"} /* 39 */,
                                       _nrn_mechanism_field<double>{"modulation_factor_ampa"} /* 40 */,
                                       _nrn_mechanism_field<double>{"modulation_factor_nmda"} /* 41 */,
                                       _nrn_mechanism_field<double>{"modulation_factor_fail"} /* 42 */,
                                       _nrn_mechanism_field<double>{"A_ampa"} /* 43 */,
                                       _nrn_mechanism_field<double>{"B_ampa"} /* 44 */,
                                       _nrn_mechanism_field<double>{"C_ampa"} /* 45 */,
                                       _nrn_mechanism_field<double>{"A_nmda"} /* 46 */,
                                       _nrn_mechanism_field<double>{"B_nmda"} /* 47 */,
                                       _nrn_mechanism_field<double>{"C_nmda"} /* 48 */,
                                       _nrn_mechanism_field<double>{"ical"} /* 49 */,
                                       _nrn_mechanism_field<double>{"ical_ampa"} /* 50 */,
                                       _nrn_mechanism_field<double>{"ical_nmda"} /* 51 */,
                                       _nrn_mechanism_field<double>{"x"} /* 52 */,
                                       _nrn_mechanism_field<double>{"PKAci"} /* 53 */,
                                       _nrn_mechanism_field<double>{"DA_ampa"} /* 54 */,
                                       _nrn_mechanism_field<double>{"DB_ampa"} /* 55 */,
                                       _nrn_mechanism_field<double>{"DC_ampa"} /* 56 */,
                                       _nrn_mechanism_field<double>{"DA_nmda"} /* 57 */,
                                       _nrn_mechanism_field<double>{"DB_nmda"} /* 58 */,
                                       _nrn_mechanism_field<double>{"DC_nmda"} /* 59 */,
                                       _nrn_mechanism_field<double>{"v"} /* 60 */,
                                       _nrn_mechanism_field<double>{"_g"} /* 61 */,
                                       _nrn_mechanism_field<double>{"_tsav"} /* 62 */,
  ...
  hoc_register_prop_size(_mechtype, 63, 8);
 ...
 pnt_receive_size[_mechtype] = 5;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 tmGlut_double /cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/tmglut_double.mod\n");
...
static void _initlists(){
 ...
 _slist1[2] = {C_ampa_columnindex, 0};  _dlist1[2] = {DC_ampa_columnindex, 0};
 ...
 _slist1[5] = {C_nmda_columnindex, 0};  _dlist1[5] = {DC_nmda_columnindex, 0};
_first = 0;
}

#if NMODL_TEXT
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/tmglut_double.mod";
