...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"modulation_kir_fs", _hoc_modulation},
...
#define modulation modulation_kir_fs
...
#define q q_kir_fs
 ...
 {"gbar_kir_fs", "S/cm2"},
 {"shift_kir_fs", "mV"},
 {"mod_pka_g_min_kir_fs", "1"},
 {"mod_pka_g_max_kir_fs", "1"},
 {"mod_pka_g_half_kir_fs", "mM"},
 {"mod_pka_g_slope_kir_fs", "mM"},
 {"ik_kir_fs", "mA/cm2"},
 {"gk_kir_fs", "S/cm2"},
 {"modulation_factor_kir_fs", "1"},
 {0, 0}
};
...
"kir_fs",
 "gbar_kir_fs",
 "shift_kir_fs",
 "mod_pka_g_min_kir_fs",
 "mod_pka_g_max_kir_fs",
 "mod_pka_g_half_kir_fs",
 "mod_pka_g_slope_kir_fs",
 0,
 "ik_kir_fs",
 "gk_kir_fs",
 "modulation_factor_kir_fs",
 0,
 "m_kir_fs",
 0,
 0};
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 kir_fs /cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/kir_fs.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "Non-inactivating inwardly rectifying potassium current (Kir2.3)";
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_kir_fs. Requires prior call to setdata_kir_fs and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/cfs/klemming/home/m/metog/BasalGangliaData/data/neurons/mechanisms/kir_fs.mod";
